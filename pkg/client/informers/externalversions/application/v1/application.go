...
import (
	...
	v1 "github.com/etiennecoutaud/demo-controller/pkg/client/listers/application/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudestV1().Applications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudestV1().Applications(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&applicationv1.Application{}, f.defaultInformer)
}
