...
import (
	...
	applicationv1 "github.com/etiennecoutaud/demo-controller/pkg/apis/application/v1"
...
var applicationsResource = schema.GroupVersionResource{Group: "cloudest.artifakt.io", Version: "v1", Resource: "applications"}

var applicationsKind = schema.GroupVersionKind{Group: "cloudest.artifakt.io", Version: "v1", Kind: "Application"}

// Get takes name of the application, and returns the corresponding application object, and an error if there is any.
func (c *FakeApplications) Get(ctx context.Context, name string, options v1.GetOptions) (result *applicationv1.Application, err error) {
	obj, err := c.Fake.
...
func (c *FakeApplications) List(ctx context.Context, opts v1.ListOptions) (result *applicationv1.ApplicationList, err error) {
	obj, err := c.Fake.
...
func (c *FakeApplications) Create(ctx context.Context, application *applicationv1.Application, opts v1.CreateOptions) (result *applicationv1.Application, err error) {
	obj, err := c.Fake.
...
func (c *FakeApplications) Update(ctx context.Context, application *applicationv1.Application, opts v1.UpdateOptions) (result *applicationv1.Application, err error) {
	obj, err := c.Fake.
...
func (c *FakeApplications) UpdateStatus(ctx context.Context, application *applicationv1.Application, opts v1.UpdateOptions) (*applicationv1.Application, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(applicationsResource, "status", c.ns, application), &applicationv1.Application{})
...
func (c *FakeApplications) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *applicationv1.Application, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(applicationsResource, c.ns, name, pt, data, subresources...), &applicationv1.Application{})
