...
import (
	...
	scheme "github.com/etiennecoutaud/demo-controller/pkg/client/clientset/versioned/scheme"
...
func newApplications(c *CloudestV1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
